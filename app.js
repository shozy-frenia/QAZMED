...
// ============================================================
// 4) AI Assistant – Stack AI token
// ============================================================
const API_URL = 'https://api.stack-ai.com/v1/chat/completions';
const API_TOKEN = 'sta_168e543e2288b6f38f2d47f8f9f162999b6f45c393c37430';
...
async function ask(text){
  ...
  try{
    const res=await fetch(API_URL, {
      ...
      body: JSON.stringify({
        model: 'gpt-4',               // adjust to your Stack AI model
        messages: [
